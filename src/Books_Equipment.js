...
function Books_Equipment(props) {
  const [bookEqlist, setbookEqlist] = useState([]);
  ...
  const [params, setParams] = useState({goshawk: "", bagshot: "", waffling: "", switch: "", spore: "", jigger: "", scamander: "", trimble: "", // kirjat
    ...
    <div>
      <div id="cont-2">
        ...
        <Container id="searchInput" margin="3em">
          <input
            name="id" type="text" placeholder="Wizard id" onChange={searchDefine}
          />
          <button /* onClick={getData} */ >Search</button>
        </Container>
        <Container id="EditInputs">
          <input id="wizardsId" name="id" type="text" placeholder="id" hidden
          /* onChange={searchDefine} */
          />
          <input id="goshawkInput" name="robes" type="text" placeholder="The Standard Book of Spells (Grade 1)" onChange={searchDefine}
          />
          <input id="bagshotInput" name="hat" type="text" placeholder="A History of Magic" onChange={searchDefine}
          />
          <input id="wafflingInput" name="gloves" type="text" placeholder="Magical Theory" onChange={searchDefine}
          />
          <input id="switchInput" name="coat" type="text" placeholder="A Beginner's Guide to Transfiguration" onChange={searchDefine}
          /><br/>
          <input id="sporeInput" name="nametags" type="text" placeholder="One Thousand Magical Herbs and Fungi" onChange={searchDefine}
          />
          <input id="jiggerInput" name="nametags" type="text" placeholder="Magical Drafts and Potions" onChange={searchDefine}
          />
          <input id="scamanderInput" name="nametags" type="text" placeholder="Fantastic Beasts and Where to Find Them" onChange={searchDefine}
          />
          <input id="trimbleInput" name="nametags" type="text" placeholder="The Dark Forces: A Guide to Self-Protection" onChange={searchDefine}
          />
